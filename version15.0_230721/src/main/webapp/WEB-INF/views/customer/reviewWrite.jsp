...
<form id="myForm" action="addReview.do" method="post" enctype="multipart/form-data">
    ...
    <div class="reviewwrap">
        ...
        <div class="review-confirm">
            ...
            <div class="uploaddiv">
                <label class="uploadlabel" for="chooseFile"><img id="img" src="${contextPath}/resources/image/camelaicon.png" class="uploadimg">사진첨부</label>
        ...
        <div class="review-button">
            <button class="review-cancel" onClick="history.back()")>취소하기</button>
